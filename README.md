...
-   **Persistent Config**: Remembers your monitored folders even after restarting the application.
...
-   **Path Management**: Easily add or remove monitored paths via the "Manage Paths" interface.
...
1.  **Add Folders**: Click **"Add Folder"** to select directories containing your Git projects. These are saved automatically.
2.  **Manage Paths**: Click **"Manage Paths"** to view or remove specific folders from monitoring.
3.  **Repo Links**: Use the **"Web"** button to open the remote repository (e.g., GitHub) or **"Folder"** to open the local directory.
4.  **Commit Message**: Enter a custom message or use the default.
5.  **Sync**: Click **"Auto Commit & Push NOW"** to force a sync immediately.
6.  **Schedule**: Enter an interval in minutes and click **"Start Scheduler"**. The countdown timer will show when the next sync will occur.
